...
SELECT
	d.productid
,	p.productname
FROM Sales.OrderDetails d INNER JOIN Production.Products p 
ON p.productid = d.productid
GROUP BY d.productid, p.productname
HAVING SUM(d.qty * d.unitprice * (1-d.discount)) > 50000;
...
(
	SELECT TOP (10)
		o.custid
	,	c.contactname
	FROM Sales.OrderValues AS o INNER JOIN Sales.Customers AS c 
